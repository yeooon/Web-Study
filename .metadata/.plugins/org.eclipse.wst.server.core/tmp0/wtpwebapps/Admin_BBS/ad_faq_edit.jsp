...
<div class="container">
	...
	<form action="" method="post">
		<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
			<thead><!-- 제목 -->
				<tr><!-- 1행 -->
					<th colspan="2" style="background-color: #eeeeee; text-align: left;">질문 등록</th>
				</tr>
			</thead>
			<tbody>
				<tr>
			...
			<button class="btn btn-default pull-right" value="글쓰기" style="width: 100px; margin-left: 10px" onclick="location.href='ad_faq_list.jsp'">취소</button>	
	</form>
	</div>
</div>
