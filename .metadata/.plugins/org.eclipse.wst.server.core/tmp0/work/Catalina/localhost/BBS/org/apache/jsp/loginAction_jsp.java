 ...
 * Generated at: 2022-06-05 08:46:32 UTC
...
public final class loginAction_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String cp = request.getContextPath();
      ...
      out.write("<title>loginAction.jsp</title>\r\n");
      ...
      out.write("\t");
		...
		// 이미 로그인이 된 사람은 또다시 로그인을 하지 못하도록 함
		String userId = null;
		...
		*/
		...
		// 로그인에서 입력한 값을 로그인 액션에서 받아옴
		// -2 ~ 1까지 result 에 값이 담기게 될 예정
		int result = userDAO.login(user.getUserId(), user.getUserPassword());
		
		if(result == 1) // 로그인 성공
		{
			session.setAttribute("userId", user.getUserId()); // 세선 부여
			PrintWriter script = response.getWriter();
			script.println("<script>");
			script.println("location.href = 'main.jsp'");
			script.println("</script>");
