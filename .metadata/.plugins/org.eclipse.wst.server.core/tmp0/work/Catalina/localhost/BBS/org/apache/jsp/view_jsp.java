 ...
 * Generated at: 2022-06-05 11:55:35 UTC
...
public final class view_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if(bbsID == 0)
	{
		...
		script.println("location.href = 'bbs.jsp'");	//-- 게시판 페이지 이동	
		script.println("</script>");		
	}
	Bbs bbs = new bbsDAO().getBbs(bbsID);
      ...
      out.print( bbs.getBbsContent().replace("\n", "<br>") );
      out.write("</td>\r\n");
      out.write("\t\t\t\t</tr>\t\t\t\t\r\n");
      out.write("\t\t\t</tbody>\r\n");
      out.write("\t\t</table>\r\n");
      ...
      out.write("\t\t");
		...
		//해당 글의 작성자가 본인이라면 수정할 수 있도록 해야 한다
		//로그인을 해서 내 아이디로 접속해야만 수정, 삭제가 보인다. 
