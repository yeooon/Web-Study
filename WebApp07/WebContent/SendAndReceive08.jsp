...
<script type="text/javascript">
	...
	// 『◀』이나 『▶』클릭 시 이동하는 함수 구현
	// ① 버튼을 클릭해도 동작 안함 → onclick 에 함수 안 집어넣었음
	...
	function check(obj)
	{
		...
		//현재 연월값 불러옴
		var sYear = Number(document.getElementById("year").value);
		var sMonth = Number(document.getElementById("month").value);
		
		sMonth += obj;
		
		// ◀ 는 -1, ▶는 +1
		// 현 상황 1월 1일(1월에 sMonth가 -1 됨)
		if(sMonth==0)
		{
			sYear-=1; 
			sMonth=12;
		}
		// 현 상황 12월 31일(12월에 sMonth가 +1 추가됨)
		else if (sMonth==13) 
		{
			sYear+=1;
			sMonth=1;
		...
		//document.frm.submit(); → 안넣어도 결과는 이상없지만... 정석인듯
