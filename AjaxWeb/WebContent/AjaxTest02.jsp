...
<script type="text/javascript">
	function sum()
	{
		...
		// 『GET』 : 데이터를 전송 및 페이지 요청 방식(POST 사용 가능, POST 사용 시 헤더 추가 필요)
		// 『url』 : AJAX 요청 페이지(데이터 수신 및 으압 페이지)
		...
		// 실제 서버에서 AJAX 요청을 한다. (즉, 이 부분이 진짜 연결 작업니다.)
...
<input type="text" id="num1" class="shart"/>
+
<input type="text" id="num2" class="shart"/>
<input type="button" value=" = " onclick="sum()""/>
<input type="text" id="result" class="shart"/>
